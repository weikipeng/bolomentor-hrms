...
//			console.log("handleMainMenu ------------------run");
//			
...
//      });
        ...
        jQuery('.page-sidebar .has-sub > a').live('click',function () {
            var handleContentHeight = function () {
                var content = $('.page-content');
                var sidebar = $('.page-sidebar');
...
//              $('#form_valid_error', $('.login-form')).show();
				valid_error =$('#form_valid_error');
				valid_error.show();
				valid_error.fadeOut(2000);
            },
            ...
            success: function (label) {
                ...
                label.remove();
//              valid_error =$('#form_valid_error', $('.login-form')); 
//              if(valid_error.is(":visible")){
////              	valid_error.hide();
//					console.log("valid_error---------------visiable");
//              }                
            },
            ...
            submitHandler: function (form) {
                ...
                //url='http://192.168.1.73:8080/unknown/project';

                /*$.get(url,function(data){
                    //alert($(data).find('tweetCount').text());
                    alert(data);                    
                });*/
                ...
                /*var tempName = document.testForm.username.name;
                //var formData = document.getElementsByName("testForm").serialize();
...
//		);
    ...
    var handleCompanyDetailValidation = function () {
...
//					window.location.href = "company_index.html";
				...
				postData[MainUrl.ACTION] = MainUrl.ACTION_UPDATE;
				postData[MString.TABLE_USER] = MStringF.getPostJson(nowUser.getJSONV());
  				...
  				console.log("589-->"+JSON.stringify(postData));
...
//							window.location.href="company_index.html";
    ...
    return {
        ...
        init: function () {
            ...
            if (App.isPage("login")) {
				$.cookie(MString.TABLE_USER,null);
            }
            
            if (App.isPage("company_index")) {
				CompanyDao.initCompany();
            }
            
            if (App.isPage("company_edit")) {
